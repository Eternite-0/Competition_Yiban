...
export default function TermsPage() {
  return (
    <div className="relative min-h-screen overflow-hidden text-ink antialiased">
      ...
      {/* 顶栏 */}
      <div className="h-[44px] flex items-center px-xl text-caption tracking-tight text-ink bg-canvas border-b border-hairline">
      ...
      <div className="max-w-[800px] mx-auto px-xl py-xxl">
        ...
        >
          ...
          <div className="prose prose-sm max-w-none text-body-muted leading-relaxed space-y-6">
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">一、总则</h2>
            ...
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">二、账号注册</h2>
              <p className="text-subhead">
            ...
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">三、用户行为规范</h2>
              <p className="text-subhead">
              ...
              <ul className="list-disc pl-6 text-subhead space-y-1">
                <li>发布、传播违法违规信息</li>
                <li>冒用他人身份进行注册或报名</li>
                <li>恶意干扰系统正常运行</li>
                <li>侵犯他人知识产权</li>
            ...
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">四、知识产权</h2>
              <p className="text-subhead">
            ...
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">五、隐私保护</h2>
              <p className="text-subhead">
            ...
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">六、免责声明</h2>
              <p className="text-subhead">
            ...
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">七、协议修改</h2>
              <p className="text-subhead">
            ...
            <section>
              <h2 className="text-callout font-semibold text-ink mt-lg mb-2">八、争议解决</h2>
              <p className="text-subhead">
